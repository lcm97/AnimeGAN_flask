...
Page({
  data: {
    ...
    swiperList: [{
      id: 0,
      type: 'image',
      url: '/images/swiper/pic1.png'
    }, {
      id: 1,
      type: 'image',
      url: '/images/swiper/pic2.png',
    }, {
      id: 2,
      type: 'image',
      url: '/images/swiper/pic3.png'
    }, {
      id: 3,
      type: 'image',
        url: '/images/swiper/pic5.png'
      }],
    //导航条
    ...
    list: [
      ...
      { id: 4, name: '敬请期待', items: [{ name: '敬请期待', url: 'pages/aitest/face_analysis/face_analysis' }, { name: '敬请期待', url: 'pages/aitest/face_analysis/face_analysis' }, { name: '敬请期待', url: 'pages/aitest/face_analysis/face_analysis' }] },
    ],
    load: true,
    menuArrow: 'arrow'
